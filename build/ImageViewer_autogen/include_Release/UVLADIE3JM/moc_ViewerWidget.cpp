...
static constexpr auto qt_meta_stringdata_CLASSViewerWidgetENDCLASS = QtMocHelpers::stringData(
    "ViewerWidget",
    "paintEvent",
    "",
    "QPaintEvent*",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSViewerWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSViewerWidgetENDCLASS_t qt_meta_stringdata_CLASSViewerWidgetENDCLASS = {
    {
